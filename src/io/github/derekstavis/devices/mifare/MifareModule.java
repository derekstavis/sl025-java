...
public abstract class MifareModule extends Thread implements IOAdapter.Callback {
	...
	public abstract void requestDataBlockRead(int blockNumber);// throws MifareSectorLoginException, MifareUnknownBlockException;
	public abstract void requestDataBlockWrite(int blockNumber, byte[] block);// throws MifareSectorLoginException, MifareUnknownBlockException;
